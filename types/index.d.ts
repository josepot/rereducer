...
// For some reason, addressing no-unnecessary-generics on this interface breaks Path
...
export const fromState: Path<FROM_STATE>;
export const fromAction: Path<FROM_ACTION>;
export const fromPayload: Path<FROM_PAYLOAD>;
export const fromMeta: Path<FROM_META>;
export const getAction: FromActionNoArgs;
export const getState: FromStateNoArgs;
